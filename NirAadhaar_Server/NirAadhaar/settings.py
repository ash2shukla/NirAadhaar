"""
Django settings for NirAadhaar project.
...
SECRET_KEY = 'n6@4yn&1c-3(k_3yaiw^2l_lfkka!4=lszy91gs+8mlcca8g7a'
...
WSGI_APPLICATION = 'NirAadhaar.wsgi.application'
...
DATABASES ={
	...
	'niraadhaardb': {
	        ...
	        'NAME': 'niraadhaardb',
	        'USER': 'niraadhaar_admin',
	        'PASSWORD': 'niraadhaar_pass',
	        'HOST': 'localhost',
	        'PORT': '5432',
	    }
}
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://:mock_pass@localhost:6379",
        "OPTIONS": {
